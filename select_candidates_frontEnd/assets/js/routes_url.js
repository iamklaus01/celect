...
export const STATS_URL = "http://localhost:8000/admin/stats";

//Admin URL
export const CREATE_ADMIN_URL = "http://localhost:8000/admin/user/register";
export const DELETE_USER_ACCOUNT = "http://localhost:8000/admin/user/delete";

//Make selection operation url
export const UPLOAD_FILE_URL = "http://localhost:8000/candidates/files/add"
export const SAVE_FEATURES_URL = "http://localhost:8000/candidates/files/add_features"
export const GET_DETAILS_INT_FEATURES_URL = "http://localhost:8000/candidates/features/int/details"
...
export const GET_SELECTION_FILE_DATA_URL = "http://localhost:8000/candidates/selection"

export const DELETE_SOLUTION_FILE_URL = "http://localhost:8000/candidates/selection/remove"



export const GET_IN_TOUCH_URL = "http://localhost:8000/user/get_in_touch"
